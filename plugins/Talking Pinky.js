...
if (conf.LANG == 'EN') vtalk_dsc = 'Starts to Toxic voice chat.', reply_eva = '*Reply to Any Voice Message!*'
...
var succ_off = ''
if (conf.LANG == 'TR') {
    fulleva_dsc = 'Tam fonksiyonel Toxic özelliklerini aktif eder. Hesabınızı bir chatbota dönüştürün!'
    already_on = 'Toxic yapay zekası halihazırda tüm fonksiyonları etkin.'
    already_off = 'Toxic yapay zekası halihazırda yarı fonksiyonel çalışıyor.'
    succ_on = 'Toxic, Tam Fonksiyonel Olarak Açıldı! Lütfen Biraz Bekleyin! ✅'
    succ_off = 'Toxic, Yarı Fonksiyonel Olarak Ayarlandı! Lütfen Biraz Bekleyin! ☑️'
}
if (conf.LANG == 'EN') {
    fulleva_dsc = 'Activates full functional Toxic features. Turn your account into a ai chatbot!'
    already_on = 'Toxic artificial intelligence is already fully functional.'
    already_off = 'Toxic artificial intelligence is currently running semi-functional.'
    succ_on = 'Toxic Opened Fully Functionally! Please wait a bit! ✅'
    succ_off = 'Toxic Set to Semi-Functional! Please wait a bit! ☑️'
}
if (conf.LANG == 'ML') {
    fulleva_dsc = 'പൂർണ്ണമായും പ്രവർത്തനക്ഷമമായ Toxic സവിശേഷതകൾ സജീവമാക്കുന്നു. നിങ്ങളുടെ അക്കൗണ്ട് ഒരു ചാറ്റ്ബോട്ടാക്കി മാറ്റുക!'
    already_on = 'Toxic കൃത്രിമബുദ്ധി ഇതിനകം പൂർണ്ണമായി പ്രവർത്തിക്കുന്നു.'
    already_off = 'Toxic AI നിലവിൽ സെമി-ഫംഗ്ഷണൽ ആണ്.'
    succ_on = 'Toxic പൂർണ്ണമായും പ്രവർത്തനക്ഷമമായി തുറന്നു! കുറച്ച് കാത്തിരിക്കൂ! ✅'
    succ_off = 'സെമി-ഫങ്ഷണൽ ആയി Toxic സജ്ജമാക്കുക! കുറച്ച് കാത്തിരിക്കൂ! ☑️'
}
